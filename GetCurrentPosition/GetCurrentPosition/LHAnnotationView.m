...
@interface LHAnnotationView()
@property (nonatomic,assign) BOOL hasCalloutView;
@property(nonatomic, strong) LHAnnotationSetting *settings;
@end

@implementation LHAnnotationView
- (instancetype)initWithAnnotation:(id<MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier pinView:(UIView *)pinView calloutView:(UIView *)calloutView settings:(LHAnnotationSetting *)settings {
...
- (void)validateSettings:(LHAnnotationSetting *)settings {
